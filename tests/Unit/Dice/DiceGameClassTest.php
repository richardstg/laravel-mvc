...
class DiceGameClassTest extends TestCase
{
    ...
    /**
     * Test assertPlayerWin
     */
    public function testAssertPlayerWin()
    {
        $diceGame = new DiceGame();
        // $diceGame->playerPlay();
    ...
    /**
     * Test assertComputerWin
     */
    public function testAssertComputerWin()
    {
        $diceGame = new DiceGame();

        $diceGame->protocol["player"] = 10;
        $diceGame->protocol["computer"] = 20;

        $diceGame->assertComputerWin();
